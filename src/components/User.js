    ...
    <div className="page_container">
      ...
      <div className="profile-container">
        <div className="profile-img">
          ...
          <button type="button" aria-label="Edit Profile Picture" className="edit-btn" onClick={handleShowPicture}><FaRegEdit /></button>
          {showPicture ? (
            <form className="user-form">
              {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
              <label htmlFor="picture">Please enter a valid image URL</label>
              <input type="text" id="picture" name="picture" value={user.picture} onChange={handleChange} />
              <button type="submit" aria-label="Upload Image" onClick={handleUpdateUser}>Upload</button>
            </form>
          ) : null}
        </div>
        <div className="profile">
          <p className="para">
            <span>Username: </span>
            <span>{user.name}</span>
            <button type="button" aria-label="Edit Username" onClick={handleShowName}><FaRegEdit /></button>
          </p>
          {showName ? (
            <form className="user-form">
              {/* eslint-disable-next-line jsx-a11y/label-has-associated-control */}
              ...
              <button type="submit" aria-label="Upload Username" onClick={handleUpdateUser}>Upload</button>
            </form>
          ) : null}
        </div>
        <p className="para">
